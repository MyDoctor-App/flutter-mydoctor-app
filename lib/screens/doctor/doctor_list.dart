...
import 'package:my_doctor_app/widgets/bottom_sheet/doctor_details_bottom_sheet.dart';
...
class _DoctorListViewState extends State<DoctorListView> {
  ...
  Future<List<dynamic>> fetchData() async {
    final response = await http
        .get(Uri.parse('https://back-end-unisenai.onrender.com/doctor'));
  ...
  Future<http.Response> deleteDoctor(int id) async {
    ...
    final response = await http.delete(
      Uri.parse("https://back-end-unisenai.onrender.com/doctor/$id"),
